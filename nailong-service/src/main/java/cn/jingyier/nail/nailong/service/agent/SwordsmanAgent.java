...
public class SwordsmanAgent {
    ...
    public SwordsmanAgent(ChatModel chatModel,
                        ...
                        @Value("${swordsman.agent.max-iterations:10}") int maxIterations) {
        ...
        try {
            ...
            try {
                ...
                writeEvent(out, "error", Map.of(
                        "type", "error",
                        "message", SwordsmanPrompts.errorMessage(),
    ...
    private List<org.springframework.ai.chat.messages.Message> buildContext(Long convId, String userContent) {
        ...
        messages.add(new SystemMessage(SwordsmanPrompts.SYSTEM_PROMPT));
